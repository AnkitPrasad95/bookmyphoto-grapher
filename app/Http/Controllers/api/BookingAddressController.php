...
class BookingAddressController extends Controller
{
    public function getaddresses(Request $request)
    {
        ...
        if(!empty($checkuser)){
            ...
            if(!empty($check)){
                $addressdata = BookingAddress::select('id','name','email','mobile','street','landmark','postcode','latitude','longitude')->where('user_id',$request->user_id)->orderByDesc('id')->paginate(10);
    ...
    public function addaddress(Request $request)
    {
        ...
        $baddress->latitude = $request->latitude;
        $baddress->longitude = $request->longitude;
        $baddress->save();
    ...
    public function editaddress(Request $request)
    {
        ...
        $addressdata = BookingAddress::join('users','booking_addresses.user_id','users.id')
                ->select('booking_addresses.id','booking_addresses.name','booking_addresses.street','booking_addresses.landmark','booking_addresses.postcode','booking_addresses.mobile','booking_addresses.email','booking_addresses.latitude','booking_addresses.longitude','users.name as user_name')
