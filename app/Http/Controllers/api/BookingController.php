...
class BookingController extends Controller
{
   ...
   public function checkcouponcode(Request $request)
   {
      ...
      $sdata = Service::select('services.*')
        ->join('users', 'users.id', 'services.provider_id')
        ->where('services.id', $request->service_id)->first();
      //$studiodata = User::where('id', $sdata->provider_id)->first();
      //dd($sdata);
      
    
      $checkcoupon = Coupons::where('studio_id', $sdata->provider_id)
