...
Route::group(['namespace'=>'api'],function (){
    ...
    Route::post('handyman/updatelocation',[HandymanController::class,'updatelocation']);
    Route::post('handyman/getlocation',[HandymanController::class,'getlocation']);
    Route::post('handyman/arrivedPhotographer',[HandymanController::class,'arrivedPhotographer']); 
    ...
    Route::post('provider/bookingimages',[HomeController::class,'bookingimages']);
    ...
    Route::get('photographerlist',[HomeController::class,'photographerlist']);
    Route::post('getPhotographerDetails',[HomeController::class,'getPhotographerDetails']);
    
     Route::get('getstates',[HomeController::class,'getstates']);
