...
return [
    ...
    */
    ...
    "enter_provider_type" => "Please enter Studio type name",
    ...
    "enter_user_id" => "Please enter user's ID",
    "enter_provider_id" => "Please enter Studio ID",
    "enter_service_id" => "Please enter service ID",
    "enter_fullname" => "Please enter fullname",
    "enter_password" => "Please enter password",
    "enter_service" => "Please enter service name",
    ...
    "enter_about_provider" => "Please enter about Studio",
    ...
    "select_provider_type" => "Please select Studio type",
    ...
    "select_category" => "Please select category of service",
    ...
    "provider_added" => "Studio added successfully",
    "provider_type_added" => "Studio type added successfully",
    ...
    "provider_updated" => "Studio updated successfully",
    "provider_type_updated" => "Studio type updated successfully",
    "mobile_added" => "Mobile added successfully",
    "handyman_assigned" => "Photographer assigned successfully",

    "provider_type_exist" => "Studio type already exist ! Try another",
    ...
    "booking_exist" => "Booking already exist !",
    ...
    "not_for_this_photografer" => "Coupon is not available for this Photografer!",
    "handyman_added" => "Photographer added successfuly",
    "handyman_updated" => "Photographer updated successfuly",
    ...
    "place_booking" => "Booking Created",
    "complete_booking" => "Booking Completed",
    "cancel_booking" => "Booking Cancelled",
    "assign_handyman" => "Photographer Assigned",
    ...
    "invalid_provider" => "Invalid Studio",
    ...
    "accepted_by_provider" => "Booking has been already accepted by Studio.",
    "cancelled_by_provider" => "Booking has been already cancelled by Studio.",
    "cancelled_by_user" => "Booking has been already cancelled by User.",
