         ...
         <div class="col-md-12">
            <div class="card">
               <div class="card-header">
                  <h4 class="card-title" id="basic-layout-icons" >{{ trans('labels.edit_service') }}</h4>  
               </div>
               <div class="card-body">
                  <div class="px-3">
                     <form class="form" id="edit_category_form" action="{{URL::to('/master-services/edit/'.$categorydata->slug)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="form-group">
                              ...
                              <select  id="category_id" class="form-control @error('category_id') is-invalid @enderror" name="category_id" required>
                                  ...
                                  <option @if($categoriesRow->id == $categorydata->category_id) {{ 'selected' }} @endif value="{{ $categoriesRow->id  }}">{{ $categoriesRow->name  }}</option>
                                  @endforeach
                              </select>
                           ...
                           <div class="form-group">
                              <div class="row">
                                 <div class="col-md-2">
                                    <label>{{ trans('labels.service_image') }}</label><br>
                           ...
                           <div class="form-actions left">
                              <a class="btn btn-raised btn-danger mr-1" href="{{ URL::to('/master-services') }}"> <i class="fa fa-arrow-left"></i> {{ trans('labels.back') }}</a>
