	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					<div class="px-3">
						<form class="form form-horizontal" id="edit_provider_form" action="{{URL::to('/providers/edit/'.$providerdata->id)}}" method="POST" enctype="multipart/form-data">
							@csrf
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-md-9">
												...
												@error('edit_provider_name')<span class="text-danger" id="name_error">{{ $message }}</span>@enderror
											</div>
										</div>
										<div class="form-group row">
