            ...
            <div class="modal-content p-4" id="modal-content">
               <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                     ...
                     <div class="w-75 pt-4 mb-4 mt-3">
                        <div class="sp-formField mb-2 d-flex position-relative form-group">
                           <div class="form-group">
                              <span class="mb-2 d-block">Search for your city</span>
                  ...
                  <div class="mb-5 col-lg-12 col-md-12 col-sm-12">
                     ...
                     <div class="px-2 row popular-city">
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/bengaluru-icon.svg" alt="Bangalore" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight text-nowrap">Bangalore</span>
                           </label>
                        </div>
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/chennai-icon.svg" alt="Chennai" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight text-nowrap">Chennai</span>
                           </label>
                        </div>
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded active py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/new-delhi-icon-active.svg" alt="Delhi - NCR" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight sp-red-color text-nowrap">Delhi - NCR</span>
                           </label>
                        </div>
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/kolkata-icon.svg" alt="Kolkata" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight text-nowrap">Kolkata</span>
                           </label>
                        </div>
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/mumbai-icon.svg" alt="Mumbai" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight text-nowrap">Mumbai</span>
                           </label>
                        </div>
                        <div class="px-2 col-lg-2 col-md-2 col-4">
                           <label class="mb-0 border d-block rounded py-3 px-2 my-2 text-center cursor-pointer">
                              <img src="https://cdn.flebo.in/assets/pune-icon.svg" alt="Pune" class="mb-2">
                              <span class="font-size-12 d-block red-hover font-semilight text-nowrap">Pune</span>
                           </label>
                        </div>
                     </div>
                  </div>
               ...
               <div class="mb-3 Other-City row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                     <h6>Other City</h6>
                     <div class="red_scrollbar px-0 col">
                        <div class="py-2 font-size-14 d-flex L-height-16 border-bottom text-capitalize">
                           ...
                           <span class="">
                              <a class="font-semilight red-hover text-dark d-block w-100" href="/">Chirkunda</a>
                           </span>
                        </div>
                        <div class="py-2 font-size-14 d-flex L-height-16 border-bottom text-capitalize">
                           <span class="icon-pincode fa fa-map-marker text-center align-self-center mr-2"></span>
                  ...
                  <div class="modal-body">
                     <div class="container-fluid">
                        <div class="row match-height" id="city_suggestion">
                           ...
                           <div class="col-lg-2 col-md-3 col-sm-2 text-center">
                                    <a onclick="setCookie('city_name','{{$cdata->name}}', 365)" href="#" >
                                       <img class="img-fluid" src="{{ Helper::image_path($cdata->image) }}" alt="{{trans('labels.city')}}">
                                    </a>
                                    <div class="text-dark">
                                       {{$cdata->name}}
                                    </div>
