<div class="col-12">
   <div id="popular-provider-owl" class="popular-provider-owl-4 owl-carousel owl-theme home_list">
      <?php 
    //   echo "<pre>";
    ...
    //   echo "</pre>";
      ...
      <div class="item">
         <div class="img">
            ...
            <!--@if($fpdata->virified_flag == 1)-->
            <div class="tag-3fdfff">
         ...
         <div class="contents bg-white">
            ...
            <p>{{Str::limit(strip_tags($fpdata->about),100)}}</p>
            <!-- <div class="rating">
