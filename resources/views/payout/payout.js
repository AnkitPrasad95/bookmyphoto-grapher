...
$(".payout_cod_pay_now").on("click",function() {
    $("#request_cod_id").val($(this).attr('data-request-id'));
    $("#provider_cod_name").val($(this).attr('data-provider-name'));
    $("#provider_cod_id").val($(this).attr('data-provider-id'));
     $("#request_cod_balance").val($(this).attr('data-request-amount'));
    $('#admin_cod_modal').modal('show');
});
